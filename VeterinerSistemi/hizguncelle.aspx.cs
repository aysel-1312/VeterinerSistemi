...
{
    public partial class hizguncelle : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (islem == "sil")
            {
                string sorgu3 = "Delete from hiztab where hizID=@pID";
        ...
        public void arama(string aranan)
        {
            ...
            baglanti.Open();
            string bastan_arama = "select hizID,hizsec,ucret from hiztab where hizsec like '%" + aranan + "%' ";
